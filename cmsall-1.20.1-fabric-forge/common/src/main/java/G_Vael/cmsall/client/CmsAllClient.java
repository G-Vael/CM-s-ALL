...
public final class CmsAllClient {
    ...
    public static void init() {
        ...
        ClientGuiEvent.INIT_POST.register((screen, access) -> {
            ...
            int y = ref != null ? ref.getY() : screen.height / 4 + 32;
            int x = ref != null ? ref.getX() - size - 4 : screen.width / 2 - 126;
    ...
    private static AbstractWidget findButton(net.minecraft.client.gui.screens.Screen screen, String translationKey) {
    ...
    public static void runCommand(String command) {
        ...
        if (mc.getConnection() != null) {
            mc.getConnection().sendCommand(command); // 1.20.1: sendUnsignedCommand doesn't exist
        }
    }
}
